...
RSpec.describe AddressBook do
	...
	describe "imports from entries2.csv file" do
		it "imports the correct number of entries" do
		...
		it "imports the 1st entry" do
			...
			check_entry(entry_one, "JimBob", "123-456-7890", "jimbob@hotmail.com")
		end
		...
		it "imports the 2nd entry" do
			...
			check_entry(entry_two, "Roxanne", "123-867-5309", "roxy@yahoo.com")
		end
		...
		it "imports the 3rd entry" do
			...
			check_entry(entry_three, "Zoe", "123-365-8687", "zoester@gmail.com")
		end
	end
end